<? 
	...
	class fun {
		...
		public static function sana($id) {
		...
		public static function number($id) {
			$sql = db::query("select * from number where id = '$id'");
			if (mysqli_num_rows($sql)) return mysqli_fetch_array($sql); else return null;
		}
		public static function number_type($id) {
			$sql = db::query("select * from number_type where id = '$id'");
			if (mysqli_num_rows($sql)) return mysqli_fetch_array($sql); else return null;
		}
		public static function number_door($id) {
			$sql = db::query("select * from number_door where id = '$id'");
			if (mysqli_num_rows($sql)) return mysqli_fetch_array($sql); else return null;
		}
