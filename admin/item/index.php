<? include "../../config/core_a.php";
	...
	if (isset($_GET['id']) || $_GET['id'] != '') {
		...
		$cours = db::query("select * from sana where id = '$cours_id'");
	...
	// 
	// $cblock = db::query("select * from number where sanatorium_id = '$cours_id' order by number asc");
	...
	<div class="uitem">
			...
			<div class="uitemc_l">
				...
				<div class="uitemci_ck">
					<div class="uitemci_ckt">
						<div class="uitemci_cktl"><h1 class="uitemci_h"><?=$cours_d['name']?></h1></div>
		...
		<div class="">
			...
			<div class="uc_d">
				...
				<? $cblock = db::query("select * from number where sana_id = '$cours_id'"); ?>
		...
		<div class="uc_list">
			...
			<div class="cours_ls">
				...
				<? $cblock = db::query("select * from sana_img where sana_id = '$cours_id' and number_id is null"); ?>			
				<? while($cblock_d = mysqli_fetch_assoc($cblock)): ?>
					<div class="cours_lsi">
				...
				<div class="form_c">
					...
					<div class="form_im form_sel">
						...
						<div class="form_im_sel sel_clc_i">
							<? $warehouses = db::query("select * from number_type"); ?>
					...
					<div class="form_im form_sel">
						...
						<i class="fal fa-caret-down form_icon_sel"></i>
						<div class="form_im_sel sel_clc_i">
							<? $warehouses = db::query("select * from number_door"); ?>
							<? while ($warehouses_d = mysqli_fetch_assoc($warehouses)): ?>
